...
it "should create a new post without saving to database" do
  post1 = Post.new(:title => "SF Marathon Underway", :description => "Expect traffic throughout the city", :author => "Sana")
...
Post.create(:title => "SF Marathon Underway", :description => "Expect traffic throughout the city", :author => "Sana")
post1 = Post.find_by_author("Sana");
